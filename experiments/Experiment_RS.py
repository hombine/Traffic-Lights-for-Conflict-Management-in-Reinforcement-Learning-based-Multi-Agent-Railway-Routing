...
log_filename = f"training_{datetime.now().strftime('%Y%m%d_%H%M%S')}_exp2.log"
...
class FlatlandRllibEnv(MultiAgentEnv):
    ...
    def __init__(self, config):
        ...
        # metric init
        self.experiment_name = config.get("experiment_name", "exp2_shaped_ppo")
...
def plot_training_curves(reward_history, completion_history, save_dir="plots"):
    ...
    plt.savefig(os.path.join(save_dir, "reward_curve_exp2.png"))
    plt.close()
    ...
    plt.savefig(os.path.join(save_dir, "completion_curve_exp2.png"))
    plt.close()
...
if __name__ == "__main__":
    ...
    metrics_dir = "metrics_exp2"
    episode_metrics_path = os.path.join(metrics_dir, "episode_metrics_exp2.csv")
    location_metrics_path = os.path.join(metrics_dir, "location_metrics_exp2.csv")
    iteration_metrics_path = os.path.join(metrics_dir, "iteration_metrics_exp2.csv")
    ...
    checkpoint_dir = os.path.abspath("exp2")
